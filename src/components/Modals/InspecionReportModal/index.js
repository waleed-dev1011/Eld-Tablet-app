...
import WeekCalendar from '../../Struct/HomeStruct/LogReportStruct/WeekCalendar';
import {mvs} from '../../../util/metrices';
import WeekCalendar2 from '../../Struct/HomeStruct/LogReportStruct/weekCalendar2';

const InspectionLogModal = ({visible, onClose}) => {
    ...
    <Modal
      ...
      <View style={styles.modalContainer}>
        ...
        <View style={styles.header}>
          ...
          <Text style={styles.date}>Log Report</Text>
          <TouchableOpacity onPress={onClose}>
            <Text>Sign</Text>
          </TouchableOpacity>
        </View>
...
export default InspectionLogModal;
